                ...
                <div className="list-block m0">
                    <div className="pr lh25 plr border_bottom">
                        <span className="di check_radius pr fl">
                            <input type="radio" id="isCheck" name="chooseTime"  className="di isConfirm" />
                    ...
                    <div className="pr lh25 personStore plr border_bottom">
                        <span className="di check_radius pr fl">
                            <input type="radio" id="isCheckOne" name="chooseTime"  className="di isConfirm" />
                    ...
                    <div className="pr lh25 personStore plr border_bottom">
                        <span className="di check_radius pr fl">
                            <input type="radio" id="isCheckTwo" name="chooseTime"  className="di isConfirm" />
